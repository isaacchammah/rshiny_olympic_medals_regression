    ...
    tabItems(
      tabItem(tabName = "Motivation",
              fluidPage(tabPanel(
                "",
                box(
                  withSpinner(htmlOutput("Motivation")),
                  width = 12,
                  border = TRUE
                )
              ))),
        ...
        fluidPage(
          tabBox(
            ...
            tabPanel("Data",
                     box(
                       htmlOutput("Datatext"),
                       withSpinner(DTOutput("Data"),), width = 12,
                     )),
            ...
            tabPanel("Multicollinearity",
                     box(
                       htmlOutput("Multitext"), withSpinner(plotOutput("Multi")), width = 12
                     )),
            ...
            tabPanel(
              ...
              box(
                htmlOutput("Plottext"),
                withSpinner(plotOutput("residualPlots")),
                width = 12,
            ...
            tabPanel(
              ...
              box(
                htmlOutput("Developedplottext"),
                withSpinner(plotOutput("residualPlots2")),
                width = 12,
                title = "Diagnostic Plots - Developed "
              ),
              box(
                htmlOutput("Underdevelopedplottext"),
                withSpinner(plotOutput("residualPlots3")),
                width = 12,
                title = "Diagnostic Plots - Underdeveloped"
              )
            ...
            tabPanel(
              ...
              box(
                htmlOutput("AICplottext"),
                withSpinner(plotOutput("residualPlots4")),
                width = 12,
                title = "Diagnostic Plots"
              )
